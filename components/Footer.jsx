    ...
    <div className={`${styles.innerWidth} mx-auto flex flex-col gap-8`}>
      ...
      <div className='flex flex-col'>
        ...
        <div className='flex items-center justify-between flex-wrap gap-4'>
          <h4 className='font-extrabold text-[24px] text-white'>Holovista</h4>
          <p className='font-normal text-[14px] text-white opacity-50'>Copyright © 2023 - 2024 Holovista by Abhiroop. All rights reserved.</p>
