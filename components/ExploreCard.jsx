...
const ExploreCard = ({id, imgUrl, title, index, active, handleClick}) => (
  <motion.div
    ...
    } flex items-center justify-center min-w-[170px] h-[700px] transition-[flex] duration-[0.7s]  cursor-pointer ease-out-flex overflow-hidden rounded-[24px]`}
  ...
  >
    ...
    (
      ...
      initial='hidden'
      animate='show'
      className='absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.75)] rounded-b-[24px]'>
